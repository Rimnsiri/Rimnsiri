...
const nsiriRim = {
  ...
  stack: ["PHP", "Laravel", "JavaScript", "React", "Vue.js"],
  databases: ["MySQL", "PostgreSQL"],
  currentlyOn: ["Projets web fullstack Laravel + React"],
  learning: "API REST, performances web & bonnes pratiques DevOps",
  passions: ["Code propre", "UI/UX moderne", "Open Source"],
};
```
